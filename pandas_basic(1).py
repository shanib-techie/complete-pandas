...
# df = pd.read_json("C:\Users\Admin\OneDrive\Desktop\daikibo-telemetry-data.json")
# # df.to_html("C:\Users\Admin\OneDrive\Desktop\daikibo-telemetry-data.json",index= False)
# print(df